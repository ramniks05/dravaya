...
const navigation = [
  ...
  { name: 'Beneficiaries', href: '/vendor/beneficiaries', icon: Users },
  { name: 'Transactions', href: '/vendor/transactions', icon: CreditCard },
  { name: 'Wallet', href: '/vendor/wallet', icon: Wallet },
  { name: 'Send Payment', href: '/vendor/payment', icon: Send },
]
        ...
        <div className="relative flex w-64 flex-col bg-white shadow-xl">
          <div className="flex h-16 items-center justify-between px-4">
            <div className="flex items-center">
              ...
              <span className="ml-2 text-lg font-semibold text-gray-900">Payout</span>
            </div>
            <button
